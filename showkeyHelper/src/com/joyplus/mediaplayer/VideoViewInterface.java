...
public interface VideoViewInterface extends ViewInterface{
	   ...
	   enum STATE{
		   ...
		   MEDIA_STATE_ERROR_FINISH (9), //State player report finish,but the video isn't finish real.
		   MEDIA_STATE_MAX          (9); //State MAX,it not a state only a flog use to jude
		   private int mState;
		   STATE(int state){
			   this.mState = state;
		   }
