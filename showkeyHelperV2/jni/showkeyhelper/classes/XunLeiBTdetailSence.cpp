...
//			addChild(divider1);
//
//			CCLabelTTF* label = CCLabelTTF::create(m_xunLeiVideInfo.getFileName().c_str(), "Arial", 32.0, CCSizeMake(800, 50), CCTextAlignment(kCCTextAlignmentLeft));
...
//			addChild(label);.
			showTitleJni(2,m_xunLeiVideInfo.getFileName().c_str());
